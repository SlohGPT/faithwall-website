            ...
            <main className="container-main pt-32 pb-16">
                <div className="prose prose-invert max-w-4xl mx-auto">
                    ...
                    <ol>
                        ...
                        <li>SUBSCRIPTIONS AND LIFETIME ACCESS</li>
                        <li>SOFTWARE</li>
                    ...
                    <h3>11. THIRD-PARTY WEBSITES AND CONTENT</h3>
                    ...
                    <p>We care about data privacy and security. Please review our Privacy Policy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in Slovakia. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Slovakia, then through your continued use of the Services, you are transferring your data to Slovakia, and you expressly consent to have your data transferred to and processed in Slovakia.</p>
                    ...
                    <p>These Legal Terms are governed by and interpreted following the laws of Slovakia, and the use of the United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law in your country to residence. FaithWall and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Nitra, which means that you may make a claim to defend your consumer protection rights in regards to these Legal Terms in Slovakia, or in the EU country in which you reside.</p>
